...
//Search for cities by user input to array
...
//Function call
createCityList();
//Search button given ablitlity to run function 
...
function getDayRepo(city) {
  ...
  fetch(requestUrl)
    ...
    .then(function (data) {
      ...
      //UV index based on latitude and longitude
...
//Fetch functon to bring up cards display
